...
namespace SR160PowerConfig
{
    public static class Lang
    {
        ...
        static Lang()
        {
            ...
            mn.Add("lblHotkey",        "Асаах/унтраах товчлол:");
            mn.Add("hotkeyNone",       "Байхгүй");
            mn.Add("hotkeyOff",        "Товчлол тохируулаагүй.");
            mn.Add("hotkeyOk",         "{0} — бэлэн. Хаанаас ч дарж болно.");
            mn.Add("hotkeyBusy",       "{0} — өөр программ эзэлсэн байна. Өөр товч сонгоно уу.");
            mn.Add("tabScan", "Скан");
            ...
            en.Add("lblHotkey",        "Start/stop hotkey:");
            en.Add("hotkeyNone",       "None");
            en.Add("hotkeyOff",        "No hotkey set.");
            en.Add("hotkeyOk",         "{0} — ready. Works from any window.");
            en.Add("hotkeyBusy",       "{0} — already taken by another program. Pick another key.");
            en.Add("tabScan", "Scan");
            ...
            zh.Add("lblHotkey",        "启动/停止快捷键：");
            zh.Add("hotkeyNone",       "无");
            zh.Add("hotkeyOff",        "未设置快捷键。");
            zh.Add("hotkeyOk",         "{0} — 已就绪，可在任意窗口使用。");
            zh.Add("hotkeyBusy",       "{0} — 已被其他程序占用，请另选一个键。");
            zh.Add("tabScan", "扫描");
            zh.Add("tabSetup", "设置");
            ...
            ru.Add("lblHotkey",        "Горячая клавиша вкл/выкл:");
            ru.Add("hotkeyNone",       "Нет");
            ru.Add("hotkeyOff",        "Горячая клавиша не задана.");
            ru.Add("hotkeyOk",         "{0} — готово. Работает из любого окна.");
            ru.Add("hotkeyBusy",       "{0} — уже занята другой программой. Выберите другую.");
            ru.Add("tabScan", "Скан");
